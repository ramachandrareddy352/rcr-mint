...
contract TokenFactory is TokenFactoryStorage, Ownable, ReentrancyGuard {
    ...
    function _mithWithCollateral(
        ...
        IERC20(m_collateralTokenAddress).safeTransferFrom(_from, address(this), _collateralAmount);
    ...
    function _mintWithPermit(
        ...
        IERC20(m_collateralTokenAddress).safeTransferFrom(_owner, _spender, _collateralAmount);
    ...
    function flashMintWithCollateral(
        ...
        IERC20(m_collateralAddress).safeTransferFrom(msg.sender, address(this), m_feeInTermsOfCollateral);
        require(
            _flashMintLogic(
                _receiver,
    ...
    function flashMintWithCollateralAndPermit(
        ...
        IERC20(m_collateralAddress).safeTransferFrom(m_initiator, m_tokenFactory, m_feeInTermsOfCollateral);
    ...
    function _flashMintLogic(
        ...
        */
        ...
        IERC20(_currencyTokenContact).safeTransferFrom(address(_receiver), _tokenFactory, _currencyAmountToMint);
